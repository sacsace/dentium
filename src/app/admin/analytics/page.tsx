...
export default async function AdminAnalyticsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-brand-navy mb-2">Visitor Analytics</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <div className="xl:col-span-2 bg-white p-6 rounded-sm shadow-sm">
          <h2 className="font-semibold text-brand-navy mb-4">Daily Trend (30 days)</h2>
          <VisitorChart data={analytics.dailyStats} />
        </div>
        <div className="bg-white p-6 rounded-sm shadow-sm">
          <h2 className="font-semibold text-brand-navy mb-4">Devices (30 days)</h2>
      ...
      <div className="bg-white p-6 rounded-sm shadow-sm">
        <h2 className="font-semibold text-brand-navy mb-4">Top Pages (30 days)</h2>
        <TopPagesTable pages={analytics.topPages} />
      </div>

      <div className="bg-white p-6 rounded-sm shadow-sm">
        <h2 className="font-semibold text-brand-navy mb-4">Recent Visits</h2>
