...
function ProfileSection({ id, title, description, icon, children, onSave, saving }: SectionProps) {
  return (
    <section id={id} className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 md:p-8 scroll-mt-28">
  ...
  return (
    <div className="space-y-6 mb-12">
      ...
      <ProfileSection
        ...
        description="Optional. You can also enter company details at checkout when placing an order."
      ...
      <ProfileSection
        ...
        description="Optional. Add your address here or at checkout when you purchase."
