  ...
  return (
    <section ref={ref} className="relative h-[50vh] min-h-[400px] overflow-hidden flex items-center justify-center">
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center px-4 max-w-4xl">
        <p className="text-brand-accent text-sm tracking-[0.35em] uppercase mb-4 font-medium">{SITE.brand} · India</p>
        <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-semibold text-white leading-tight text-balance">
