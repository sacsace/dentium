    ...
    <section className="py-20 md:py-24 bg-brand-navy text-white">
      <div className="container mx-auto px-4 lg:px-8">
        <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <p className="text-brand-accent/90 text-[11px] md:text-xs font-semibold tracking-[0.18em] uppercase mb-3">
              Seminars & Events
            </p>
            <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight">Upcoming Events</h2>
          </div>
          <Link
            href="/events"
            className="inline-flex items-center gap-2 text-white/75 font-semibold text-sm border-b border-white/20 pb-0.5 hover:text-white hover:border-brand-accent transition-colors"
          >
